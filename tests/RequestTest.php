...
class RequestTest extends TestCase {
  ...
  public function testHeader() {
    $this->request_set_clear_data();
    $this->request_set_server_data(['HTTP_HOST' => 'coesion']);
    $this->assertEquals('coesion', Request::header('host'));
  }
  ...
  public function testAllHeader() {
    ...
    $this->request_set_server_data([
      'HTTP_HOST'     => 'coesion',
      'HTTP_REFERER'  => 'coesion.com'
    ]);
    $this->assertEquals("coesion", Request::header()['HTTP_HOST']);
    $this->assertEquals("coesion.com", Request::header()['HTTP_REFERER']);
  }
  ...
  public function testInputAll() {
    ...
    $_REQUEST = ['alpha' => 'beta'];
    $all = Request::input();
    $this->assertEquals('beta', $all['alpha']);
  }
