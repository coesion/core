  ...
  public function testGroupsExtraction() {
   ...
   public function testFullyOptionalRoute() {
    ...
    public function testRoutePushes() {
      ...
      $this->assertStringContainsString('Link: </main.js>; rel=preload; as=script',      $compiled_headers, 'RoutePushes.1');
      $this->assertStringContainsString('Link: </fonts/a.woff>; rel=preload; as=font',   $compiled_headers, 'RoutePushes.2');
      $this->assertStringContainsString('Link: </fonts/b.ttf>; rel=preload; as=font',    $compiled_headers, 'RoutePushes.3');
      $this->assertStringContainsString('Link: </imgs/test.png>; rel=preload; as=image', $compiled_headers, 'RoutePushes.4');
      $this->assertStringContainsString('Link: </idk.txt>; rel=preload; as=text',        $compiled_headers, 'RoutePushes.5');
      ...
      $compiled_headers = implode("\n",$compiled_headers);
      $this->assertStringContainsString('Link: </main.js>; rel=preload; as=script',      $compiled_headers, 'RouteGroupPushes.1');
      $this->assertStringContainsString('Link: </fonts/a.woff>; rel=preload; as=font',   $compiled_headers, 'RouteGroupPushes.2');
      $this->assertStringContainsString('Link: </fonts/b.ttf>; rel=preload; as=font',    $compiled_headers, 'RouteGroupPushes.3');
      $this->assertStringContainsString('Link: </imgs/test.png>; rel=preload; as=image', $compiled_headers, 'RouteGroupPushes.4');
      $this->assertStringContainsString('Link: </idk.txt>; rel=preload; as=text',        $compiled_headers, 'RouteGroupPushes.5');
    }
