...
class EmailTest extends TestCase {
	...
	public function testStandardEnvelope() {
		...
		$this->assertNotFalse(strpos($email_src, "To: Stefano <stefano@coesion.com>, test@email.it\r\n"), "TO not found");
	...
	public function testEmailFacade() {
		...
		$this->assertTrue($success, "Email.Send(array) failed.");
		...
		$this->assertTrue($success, "Email.Send(envelope) failed.");
