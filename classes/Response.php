...
class Response {
     ...
     * Intended for long-lived processes (e.g., worker mode).
     */
    ...
    public static function json($payload){
        ...
        static::$payload[] = json_encode(
          value: $payload,
          flags: Options::get('core.response.json_flags',JSON_NUMERIC_CHECK|JSON_BIGINT_AS_STRING)
        );
    }
