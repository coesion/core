 ...
 * @author Stefano Azzolini <lastguest@gmail.com>
  ...
  */
  ...
  public static function removeAccents($text){
    static $map = null;
    if ($map === null) {
      $from = preg_split('//u', 'àáâãäçèéêëìíîïñòóôõöùúûüýÿÀÁÂÃÄÇÈÉÊËÌÍÎÏÑÒÓÔÕÖÙÚÛÜÝ', -1, PREG_SPLIT_NO_EMPTY);
      $to   = str_split('aaaaaceeeeiiiinooooouuuuyyAAAAACEEEEIIIINOOOOOUUUUY');
